# Obfuscator from https://github.com/Blank-c/BlankOBF
...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using https://github.com/Blank-c/BlankOBF in https://github.com/DARKNOSY/Py2ExeXobfuscator
